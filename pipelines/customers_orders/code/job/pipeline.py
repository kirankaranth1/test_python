...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "1567/pipelines/customers_orders")
    MetricsCollector.start(spark = spark, pipelineId = "1567/pipelines/customers_orders")
    pipeline(spark)
